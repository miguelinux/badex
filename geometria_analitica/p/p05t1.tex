...
\question Usa la siguiente cuadricula para resolver los siguientes incisos:
  ...
  \begin{tikzpicture}
    \begin{axis}[grid=both,ymin=-6,ymax=6,xmax=8,xmin=-8,xticklabel=\empty,yticklabel=\empty,
      ...
      \node[label={10:{A}},circle,fill,inner sep=2pt] at (axis cs:0,5) {};
      \node[label={180:{B}},circle,fill,inner sep=2pt] at (axis cs:-4,2) {};
      \node[label={230:{C}},circle,fill,inner sep=2pt] at (axis cs:-4,-4) {};
      \node[label={260:{D}},circle,fill,inner sep=2pt] at (axis cs:-1,-4) {};
      \node[label={180:{E}},circle,fill,inner sep=2pt] at (axis cs:-1,-1) {};
      \node[label={0:{F}},circle,fill,inner sep=2pt] at (axis cs:1,-1) {};
      \node[label={280:{G}},circle,fill,inner sep=2pt] at (axis cs:1,-4) {};
      \node[label={320:{H}},circle,fill,inner sep=2pt] at (axis cs:4,-4) {};
      \node[label={30:{I}},circle,fill,inner sep=2pt] at (axis cs:4,2) {};
    \end{axis}
  \end{tikzpicture}
